...
export class CategoriesController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new category in the system. Requires authentication token. Automatically assigns branch_id from authenticated user if not provided.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a list of categories. Can filter by branch ID. If user is authenticated, returns categories from their branch by default.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific category by its unique identifier including parent and child relationships.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Updates category information. Only provided fields will be updated. Requires authentication.',
  })
  @ApiResponse({
    status: 200,
    ...
    schema: {
      example: {
        ...
        description:
          'Productos electrónicos y accesorios - versión actualizada',
        sort_order: 2,
        is_active: true,
      },
    },
  ...
  @ApiOperation({
    ...
    description:
      'Permanently deletes a category from the system. Cannot delete if category has associated products.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Updates the sort order of multiple categories. Requires authentication and branch permissions.',
  })
  @ApiResponse({
    status: 200,
