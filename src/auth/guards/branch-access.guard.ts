...
export class BranchAccessGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    const targetBranchId = request.params.branchId || request.query.branchId || request.body.branch_id;
    ...
    if (targetBranchId && user.branch_id !== targetBranchId) {
      throw new ForbiddenException('You can only access resources from your assigned branch');
    }
