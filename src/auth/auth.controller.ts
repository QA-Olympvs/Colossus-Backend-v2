...
export class AuthController {
  ...
  @ApiOperation({
    summary: 'User login',
    description:
      'Authenticates a user with email and password. Returns JWT token for authenticated sessions.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new user account. Requires email, password, and user details.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves detailed information about the current authenticated user including roles and permissions.',
  })
  @ApiResponse({
    status: 200,
