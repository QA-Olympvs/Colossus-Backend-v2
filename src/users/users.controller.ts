...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new user account with roles and permissions. Requires authentication and appropriate permissions.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a list of users. Can filter by branch ID. Requires authentication and appropriate permissions.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific user by their unique identifier including roles, permissions, and branch information.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: 'Update user',
    description:
      'Updates user information. Only provided fields will be updated. Requires authentication and appropriate permissions.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: 'Delete user',
    description:
      'Permanently deletes a user from the system. Cannot delete if user has associated orders or critical data.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Assigns a specific role to a user. Requires authentication and appropriate permissions.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Removes a specific role from a user. Requires authentication and appropriate permissions.',
  })
  @ApiResponse({
    status: 200,
